...
using Xbim.Ifc4x3.GeometricConstraintResource;        //IfcLocalPlacement
using Xbim.Ifc4x3.GeometryResource;                   //IfcAxis2Placement3D
using Xbim.Ifc4x3.RepresentationResource;             //Geometric Representation Context
using Xbim.Ifc4x3.MeasureResource;                    //IfcNamedUnit
