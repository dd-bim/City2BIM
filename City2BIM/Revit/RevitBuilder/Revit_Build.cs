...
namespace City2BIM.RevitBuilder
{
    public static class Revit_Build
    {
        ...
        public static List<CurveLoop> CreateCurveLoopList(List<C2BPoint> exteriorRing, List<List<C2BPoint>> interiorRings, out XYZ planeNormal, C2BPoint calcOffset = null)
        {
            ...
            {
                C2BPoint unprojectedPt = GeorefCalc.CalcUnprojectedPoint(pt, City2BIM_prop.IsGeodeticSystem, calcOffset); //calc unprojected coords
        ...
        {
            var revitPt = xmlPt / Revit_Prop.feetToM;
