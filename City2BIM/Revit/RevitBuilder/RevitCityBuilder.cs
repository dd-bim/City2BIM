...
namespace City2BIM.RevitBuilder
{
    ...
    {
        private readonly City2BIM.GetGeometry.C2BPoint gmlCorner;
        private readonly Document doc;

        private readonly List<GmlRep.CityGml_Bldg> buildings;
        private readonly Dictionary<GmlRep.CityGml_Surface.FaceType, ElementId> colors;


        public RevitCityBuilder(Document doc, List<GmlRep.CityGml_Bldg> buildings, GetGeometry.C2BPoint gmlCorner)
        {
            this.doc = doc;
        ...
        private void CreateLOD1Building(string internalID, C2BSolid solid, List<CityGml_Surface> surfaces, Dictionary<Xml_AttrRep, string> attributes, ref List<LogPair> logEntries, ref double error, ref double errorLod1, Dictionary<Xml_AttrRep, string> partAttributes = null)
        {
            ...
            foreach (var groundSurface in groundSurfaces)
            {
                ...
                var extrHeight = height / Revit_Prop.feetToM;
        ...
        private void CreateRevitFaceRepresentation(CityGml_Surface surface, Dictionary<Xml_AttrRep, string> bldgAttributes, string lod, Dictionary<Xml_AttrRep, string> partAttributes = null)
        {
            ...
            double height = 0.01 / Revit_Prop.feetToM;
        ...
        private Dictionary<GmlRep.CityGml_Surface.FaceType, ElementId> CreateColorAsMaterial()
        {
            ...
            var colorList = new Dictionary<GmlRep.CityGml_Surface.FaceType, ElementId>
            {
                { GmlRep.CityGml_Surface.FaceType.roof, roofCol },
                { GmlRep.CityGml_Surface.FaceType.wall, wallCol },
                { GmlRep.CityGml_Surface.FaceType.ground, groundCol },
                { GmlRep.CityGml_Surface.FaceType.outerCeiling, groundCol },
                { GmlRep.CityGml_Surface.FaceType.outerFloor, groundCol },
                { GmlRep.CityGml_Surface.FaceType.closure, closureCol },
                { GmlRep.CityGml_Surface.FaceType.unknown, wallCol }
            };
