...
namespace City2BIM.RevitCommands.NAS2BIM
{
    /// <summary>
    /// Interaction logic for CityGML_settings.xaml
    /// </summary>
    public partial class NAS_settings : Window
    {
        ...
        public NAS_settings()
        {
            ...
            tb_file.Text = NAS2BIM_prop.FileUrl;
            ...
            if (NAS2BIM_prop.IsGeodeticSystem)
            ...
            if (RevitBuilder.Revit_Prop.TerrainId == null)
            {
        ...
        private void Bt_browse_Click(object sender, RoutedEventArgs e)
        {
            ...
            tb_file.Text = imp.ImportPath(FileDialog.Data.ALKIS);
        ...
        private void Bt_apply_Click(object sender, RoutedEventArgs e)
        {
            ...
            NAS2BIM_prop.FileUrl = tb_file.Text;
            ...
            if ((bool)rb_YXZ.IsChecked)
                ...
                NAS2BIM_prop.IsGeodeticSystem = false;
            ...
            if (check_drapeBldgs.IsChecked == true)
                NAS2BIM_prop.DrapeBldgsOnTopo = true;

            if (check_drapeParcels.IsChecked == true)
                NAS2BIM_prop.DrapeParcelsOnTopo = true;

            if (check_drapeUsage.IsChecked == true)
                NAS2BIM_prop.DrapeUsageOnTopo = true;
